export const serviceDetails = {
  ...
  irm: {
    ...
    preparation:
      "Enlever tout objet métallique. À jeun dans certains cas (IRM abdominale).",
  ...
  scanner: {
    ...
    preparation:
      "Être à jeun selon la région scannée. Injection de produit de contraste possible.",
  ...
  echographie: {
    ...
    uses: [
      "Suivi de grossesse",
      "Examens abdominaux",
      "Écho-Doppler des vaisseaux",
    ],
    preparation:
      "Boire de l’eau pour une échographie pelvienne. À jeun pour l’abdomen.",
