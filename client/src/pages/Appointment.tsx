      ...
      <section className="py-16 bg-gradient-to-r from-primary to-secondary text-white relative">
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold font-heading mb-4">{t('appointment.title')}</h2>
            <p className="text-lg max-w-2xl mx-auto">{t('appointment.description')}</p>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600">{t('appointment.stepsDescription')}</p>
            </div>
            ...
            <div className="mt-12 bg-light rounded-lg p-8">
              ...
              <p className="mt-6 text-gray-600">{t('appointment.finalNote')}</p>
            </div>
          </div>
        </div>
      </section>
