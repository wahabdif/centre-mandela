...
export const services: ServiceProps[] = [
  {
    ...
    image:
      'https://images.pexels.com/photos/4226219/pexels-photo-4226219.jpeg?auto=compress&cs=tinysrgb&w=1500',
  },
  {
    id: 'irm',
    icon: 'magnet',
    ...
    image:
      'https://images.pexels.com/photos/6749773/pexels-photo-6749773.jpeg?auto=compress&cs=tinysrgb&w=1500',
  },
  {
    id: 'scanner',
    icon: 'laptop-medical',
    ...
    image:
      'https://images.pexels.com/photos/4225880/pexels-photo-4225880.jpeg?auto=compress&cs=tinysrgb&w=1500',
  },
  {
    id: 'echographie',
    icon: 'search',
    ...
    image:
      'https://images.pexels.com/photos/5407206/pexels-photo-5407206.jpeg?auto=compress&cs=tinysrgb&w=1500',
  },
];
...
export const testimonials: Testimonial[] = [
  ...
  },
  {
    ...
    rating: 5,
    avatar:
      'https://images.unsplash.com/photo-1584999734482-0361aecad844?q=80&w=150&h=150&auto=format&fit=crop',
  },
];
...
export const contactInfo: ContactInfo = {
  ...
  location: { lat: 35.698, lng: -0.6435 },
};
...
export const features: Feature[] = [
  {
    ...
    image:
      'https://images.unsplash.com/photo-1622253694242-abeb37a33e97?q=80&w=400&auto=format&fit=crop',
  },
  {
    icon: 'cog',
    ...
    image:
      'https://images.unsplash.com/photo-1587854680352-936b22b91030?q=80&w=400&auto=format&fit=crop',
  },
  {
    icon: 'clock',
    ...
    image:
      'https://images.unsplash.com/photo-1584982751601-97dcc096659c?q=80&w=400&auto=format&fit=crop',
  },
];
...
export const heroImages: HeroImages = {
  ...
  services:
    'https://images.pexels.com/photos/4226140/pexels-photo-4226140.jpeg?auto=compress&cs=tinysrgb&w=1800',
  appointment:
    'https://images.pexels.com/photos/7089401/pexels-photo-7089401.jpeg?auto=compress&cs=tinysrgb&w=1800',
  testimonials:
    'https://images.pexels.com/photos/7088530/pexels-photo-7088530.jpeg?auto=compress&cs=tinysrgb&w=1800',
  contact:
    'https://images.pexels.com/photos/6129507/pexels-photo-6129507.jpeg?auto=compress&cs=tinysrgb&w=1800',
};
