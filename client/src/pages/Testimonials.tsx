...
export default function Testimonials() {
  ...
  const extendedTestimonials = [
    ...
    {
      id: 4,
      text: t('testimonials.extended.0.text') as string,
      author: t('testimonials.extended.0.author') as string,
      role: t('testimonials.extended.0.role') as string,
      initials: 'SL',
      rating: 5,
    },
    {
      id: 5,
      text: t('testimonials.extended.1.text') as string,
      author: t('testimonials.extended.1.author') as string,
      role: t('testimonials.extended.1.role') as string,
      initials: 'MA',
      rating: 5,
    },
    {
      id: 6,
      text: t('testimonials.extended.2.text') as string,
      author: t('testimonials.extended.2.author') as string,
      role: t('testimonials.extended.2.role') as string,
      initials: 'FZ',
      rating: 5,
    },
  ];
