...
// Type représentant un message complet stocké en base
...
// Type pour insertion, avec options facultatives pour message et status
export type InsertContactMessage = {
  ...
  service: string;
  message?: string | null;
  status?: string; // Par défaut "pending" si absent
};
